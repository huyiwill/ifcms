...
<div class="content bgcolor-fff play-header" style="display: none;" name="play-header">
    <div class="container">
        ...
        <div id="banner" class="content">
            <ul id="banner_img">
                <?php $__SLIDER__ = D('Tag')->getSlider(9,"id,title,cover_id,link"); if(is_array($__SLIDER__)): $i = 0; $__LIST__ = $__SLIDER__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$slider): $mod = ($i % 2 );++$i;?><li>
            ...
            <div id="banner_ctr" class="banner-right">
                <ul>
                    <?php $__SLIDER__ = D('Tag')->getSlider(9,"id,title,cover_id,link"); if(is_array($__SLIDER__)): $i = 0; $__LIST__ = $__SLIDER__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$slider): $mod = ($i % 2 );++$i;?><li><?php echo ($slider["title"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
        </div>
