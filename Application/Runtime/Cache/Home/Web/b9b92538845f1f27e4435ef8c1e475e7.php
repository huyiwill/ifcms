	...
	<div style="width: 100%; padding-bottom: 20px">
		<span id="counter-box">
			<div class="global-nav">
				<ul>
					<li>
						<h4 class="pull-left" style="display: inline-block;font-weight: initial;font-size: <?php echo ($size+4); ?>px">精彩影评</h4>
						<h5 class="pull-left" style="display: inline-block;font-weight: initial;font-size:<?php echo ($size); ?>px">已盖 <span style="color:#f10"><?php echo ($count); ?></span> 楼</h5>
					</li>
				</ul>
			</div>
		</span>
						...
						<div class="postarea">
							<div class="postborder">
								<div class="layui-form" style="position: relative;">
									...
									width: 99.8%;height: 128px;font-size: <?php echo ($size); ?>px;box-sizing:border-box;padding:10px">您还未登录，请先 <a href="<?php echo U('User/Public/login');?>" style="color:#f20" target="_parent">登录</a> 后再发表评论。</div>
									<?php else: ?>
							...
							<div style="display: block;text-align: right;margin-top:8px">
								<span style="font-size: <?php echo ($size); ?>px;color:#f20">注意，以下行为将被封号：严重剧透、发布广告、木马链接、宣传同类网站、等骂工作人员等。</span>
		...
		<span id="nav-box">
			<div class="nav">
				<div class="nav-left">
					<span style="font-size: <?php echo ($size+4); ?>px;"> 最新影评</span>
				</div>
				<div class="claer"></div>
			</div>
		</span>
