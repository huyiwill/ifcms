    ...
    <div class="container">
		...
		<div class="content margin-t30">
			<div class="container">
				...
				<div class="col col12 ts-move-list move-list">
					<?php $__LIST__ = D('Tag')->lists($cid, "update_time desc","9", 1,"true",$pos); if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i; if(($i) == "1"): ?><div class="col col36">
								<a href="<?php echo ($list['url']); ?>">
									<div class="list-img">
									...
									<dl class="profiles bgcolor-fff text-left">
										<dt class="f16 h33"><?php echo (msubstr($list['title'],0,9)); ?></dt>
		...
		<?php $__NAV__ = D('Tag')->getNav($cid,"",1,"id,title,name,pid,link"); if(is_array($__NAV__)): $i = 0; $__LIST__ = $__NAV__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?><div class="content margin-t30">
			<div class="container">
				<div class="col col12 color-line">
					<h3 class="public_title">
						<span>最新<?php echo ($nav['title']); ?></span>
					</h3>
					<div class="subtitle f14 h88">
						<a href="<?php echo ($nav['url']); ?>">更多&gt;&gt;</a>
					</div>
				</div>
				<div class="col col12 move-list">
					<?php $__LIST__ = D('Tag')->lists($nav['id'], "update_time desc","6", 1,"true"); if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="col col26">
						<a href="<?php echo ($list['url']); ?>">
                            <?php switch($list["tj_tag"]): case "1": ?><span class="tip tip-new"></span><?php break;?>
                                <?php case "2": ?><span class="tip tip-hot"></span><?php break;?>
                                <?php case "3": ?><span class="tip tip-big"></span><?php break;?>
